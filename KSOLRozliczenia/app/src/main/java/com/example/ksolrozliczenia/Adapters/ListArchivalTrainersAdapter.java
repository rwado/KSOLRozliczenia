...
public class ListArchivalTrainersAdapter extends BaseAdapter implements ListAdapter {

    private List<Order> orders;
    private Context context;

    public ListArchivalTrainersAdapter(List<Order> orders, Context context) {
        this.orders = orders;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view == null) {
            ...
            view = inflater.inflate(R.layout.list_orders_archival_trainers_layout,null);
        }

        TextView textDescription = view.findViewById(R.id.textDescription);
        TextView textQuantity = view.findViewById(R.id.textQuantity);
        TextView textSender = view.findViewById(R.id.textSender);
