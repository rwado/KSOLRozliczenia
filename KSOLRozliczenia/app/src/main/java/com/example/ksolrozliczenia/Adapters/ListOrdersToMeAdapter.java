...
public class ListOrdersToMeAdapter extends BaseAdapter implements ListAdapter {

    private List<Order> orders;
    private Context context;

    public ListOrdersToMeAdapter(List<Order> orders, Context context) {
        this.orders = orders;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        TextView textRecipient = view.findViewById(R.id.textRecipientOrdersGiven);
        ...
        textRecipient.setText(orders.get(i).getSenderName());
